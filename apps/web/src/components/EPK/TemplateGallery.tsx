...
export function TemplateGallery({
  ...
  const [previewTemplate, setPreviewTemplate] = useState<EPKTemplate | null>(
    null,
  );
          ...
          modules: [
            {
              ...
              order: 0,
              data: {
                text: "Sample artist biography showcasing this template style...",
              },
            },
          ],
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filteredTemplates.map((template) => (
          ...
          >
            <div
              className="aspect-[4/5] bg-gradient-to-br relative overflow-hidden"
              style={{
            ...
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
                <Sparkles
                  ...
                  style={{ color: template.colorScheme.text || "#fff" }}
                />
      ...
      {previewTemplate && (
        ...
        >
          <div
            className="bg-[#0a0a0a] border border-primary rounded-lg max-w-5xl w-full max-h-[90vh] overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between p-4 border-b border-[#1a1a1a]">
              <h3 className="text-xl font-bold text-white">
                {previewTemplate.name} - Quick Preview
              </h3>
              <button
                onClick={() => setPreviewTemplate(null)}
