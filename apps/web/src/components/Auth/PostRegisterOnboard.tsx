...
export function PostRegisterOnboard({
  open,
  jobId,
  onOpenChange,
}: PostRegisterOnboardProps) {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[800px] bg-[#0F0F0F] border border-[#262626] rounded-2xl p-8 shadow-2xl">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  needsReview || isVerified || isRejected
                    ? "bg-green-500/20 text-green-500"
                    : "bg-gray-700 text-gray-400"
                }`}
              >
          ...
          <div className="mb-6">
            ...
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div
                ...
                style={{
                  width: jobStatus?.status === "processing" ? "75%" : "25%",
                }}
              />
            </div>
          </div>
          ...
          <div className="p-4 bg-yellow-500/10 border border-yellow-500/50 rounded-lg mb-6">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  A curator will review within 24-72 hours. You'll receive an
                  email notification.
                </p>
              </div>
            </div>
          ...
          <div className="p-4 bg-destructive/10 border border-destructive/50 rounded-lg mb-6">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {jobStatus?.error ||
                    "The submitted profile could not be verified. Please contact support."}
                </p>
              </div>
            </div>
          </div>
        ...
        <p className="text-xs text-center text-muted-foreground mt-4">
          Keep this window open. We'll pop onboarding as soon as you're
          verified.
        </p>
      </div>
    </div>
