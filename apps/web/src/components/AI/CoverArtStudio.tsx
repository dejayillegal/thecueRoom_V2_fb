...
const STYLE_PRESETS = [
  {
    ...
    description: "Purple/pink glow, chrome shapes",
  },
  {
    id: "monochrome",
    label: "Monochrome",
    gradient: "from-gray-900 to-gray-400",
    description: "Black/white brutalist grid",
  },
  {
    id: "geometric",
    label: "Geometric",
    gradient: "from-orange-500 via-yellow-500 to-orange-600",
    description: "Polygons, structured shapes",
  },
  {
    id: "brutalist",
    label: "Brutalist",
    gradient: "from-gray-800 via-red-800 to-gray-900",
    description: "Industrial gradients, textures",
  },
  {
    id: "cybergrind",
    label: "Cybergrind",
    gradient: "from-black via-cyan-500 to-green-500",
  ...
  },
  {
    ...
    description: "Pastel gradients, digital sun",
  },
  {
    id: "chromatic-grid",
    label: "Chromatic Grid",
    gradient: "from-red-500 via-green-500 to-blue-500",
    description: "Rainbow grids, blur filters",
  },
  {
    id: "noir-light",
    label: "Noir Light",
    gradient: "from-black via-gray-500 to-white",
    description: "High-contrast light shafts",
  },
  {
    id: "acid-geometry",
    label: "Acid Geometry",
    gradient: "from-yellow-400 via-green-400 to-cyan-400",
    description: "Neon geometric chaos",
  },
  {
    id: "liquid-metal",
    label: "Liquid Metal",
    gradient: "from-gray-400 via-gray-100 to-gray-500",
    description: "Silver distortions, wave mesh",
  },
];
          ...
          <div className="space-y-4">
            <div>
              ...
              <Textarea
                ...
                placeholder={
                  hasAIKey === false
                    ? "AI prompt disabled - using procedural SVG generation"
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                  {STYLE_PRESETS.map((preset) => (
                    ...
                    >
                      <div
                        className={`h-12 rounded bg-gradient-to-r ${preset.gradient} mb-2 transition-transform group-hover:scale-105`}
                      />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="artist" className="text-white text-sm">
                  Artist Name
                </Label>
                <Input
                  id="artist"
              ...
              <div>
                <Label htmlFor="release" className="text-white text-sm">
                  Release Title
                </Label>
                <Input
                  id="release"
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <Label htmlFor="aspect" className="text-white text-sm">
                  Aspect Ratio
                </Label>
                <select
                  id="aspect"
            ...
            {hasAIKey === false && (
              <p className="text-xs text-gray-500 text-center">
                🎨 Generated locally — Add HF_TOKEN or GOOGLE_API_KEY to enable
                AI generation
              </p>
            )}
          </div>
      ...
      <Card className="bg-[#111111] border-[#1a1a1a] p-6">
        ...
        <ul className="space-y-3 text-sm text-gray-400">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong className="text-white">Fallback Mode:</strong> No AI key
              required - generates high-quality procedural SVG art
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#D1FF3D] mt-1">•</span>
            <span>
              <strong className="text-white">Randomize:</strong> Click to get a
              random preset and seed for unique variations
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#D1FF3D] mt-1">•</span>
            <span>
              <strong className="text-white">Style Presets:</strong> Each preset
              uses distinct algorithms for professional results
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#D1FF3D] mt-1">•</span>
            <span>
              <strong className="text-white">Artist/Release:</strong> Add text
              to be integrated into the artwork design
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#D1FF3D] mt-1">•</span>
            <span>
              <strong className="text-white">Seed:</strong> Use the same seed to
          ...
          <li className="flex items-start gap-2">
            <span className="text-[#D1FF3D] mt-1">•</span>
            <span>
              <strong className="text-white">AI Mode:</strong> Add HF_TOKEN to
              Secrets for Hugging Face Stable Diffusion XL
            </span>
          </li>
        </ul>
          ...
          <div className="grid grid-cols-2 gap-2">
            {STYLE_PRESETS.slice(0, 6).map((preset) => (
              <div key={preset.id} className="text-xs">
                <div
                  className={`h-3 rounded bg-gradient-to-r ${preset.gradient} mb-1`}
                />
