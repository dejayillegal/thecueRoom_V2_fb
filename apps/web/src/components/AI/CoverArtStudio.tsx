        ...
        <div className="space-y-3">
          {recentRenders.length === 0 ? (
            ...
            recentRenders.map((render) => (
              <div key={render.id} className="bg-[#0a0a0a] rounded-lg p-3 border border-[#1a1a1a]">
                <img src={render.url} alt={render.prompt} className="w-full h-24 object-cover rounded mb-2" />
