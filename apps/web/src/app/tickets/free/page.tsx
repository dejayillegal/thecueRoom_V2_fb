      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-400 text-sm">
            Create QR-based free tickets for your events
          </p>
        </div>
        ...
        <Card className="bg-[#111111] border-[#1a1a1a] p-6">
          {!ticket ? (
            <div className="space-y-4">
              <div>
                <Label htmlFor="eventSlug" className="text-white text-sm">
                  Event ID
                </Label>
                <Input
                  id="eventSlug"
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, eventSlug: e.target.value })
                  }
              ...
              <div>
                <Label htmlFor="holderName" className="text-white text-sm">
                  Your Name
                </Label>
                <Input
                  id="holderName"
              ...
              <div>
                <Label htmlFor="holderEmail" className="text-white text-sm">
                  Email
                </Label>
                <Input
                  id="holderEmail"
              ...
              <Button
                ...
                disabled={
                  isGenerating || !formData.eventSlug || !formData.holderEmail
                }
