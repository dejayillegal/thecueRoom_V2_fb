...
export interface EPKTemplate {
  ...
  modules: string[];
  description: string;
  category: 'modern' | 'minimalist' | 'editorial' | 'futuristic' | 'retro' | 'premium' | 'visual';
  thumbnailSvg: string;
  colorScheme: {
    primary: string;
    accent: string;
...
export const EPK_TEMPLATES: EPKTemplate[] = [
  {
    ...
    colorScheme: { primary: '#0B0B0B', accent: '#D1FF3D', background: '#000', text: '#FFF' }
  },
  {
    id: 'minimalist-clean',
    ...
    colorScheme: { primary: '#000', accent: '#FFF', background: '#FAFAFA', text: '#1A1A1A' }
  },
  {
    ...
    colorScheme: { primary: '#1A1A1A', accent: '#FF3366', background: '#F8F8F8', text: '#2A2A2A' }
  },
  {
    id: 'tech-neon',
    name: 'Tech Neon',
    ...
    colorScheme: { primary: '#0A0E27', accent: '#00FFD1', background: '#0D1117', text: '#E6E6E6' }
  },
  {
    id: 'vintage-poster',
    name: 'Vintage Poster',
    ...
    colorScheme: { primary: '#2C1810', accent: '#D4A574', background: '#F4E8D8', text: '#3A2415' }
  },
  {
    id: 'glass-modern',
    name: 'Glass Morphism',
    ...
    colorScheme: { primary: '#1E1E1E', accent: '#A78BFA', background: '#F3F4F6', text: '#111827' }
  },
  {
    id: 'dark-luxury',
    name: 'Dark Luxury',
    ...
    colorScheme: { primary: '#0A0A0A', accent: '#FFD700', background: '#121212', text: '#E5E5E5' }
  },
  {
    id: 'grid-mosaic',
    name: 'Grid Mosaic',
    ...
    colorScheme: { primary: '#18181B', accent: '#F59E0B', background: '#FAFAFA', text: '#27272A' }
  },
  {
    id: 'poster-stack',
    name: 'Poster Stack',
    ...
    colorScheme: { primary: '#1A1A1A', accent: '#D1FF3D', background: '#000', text: '#FFF' }
  },
  {
    id: 'modular-studio',
    name: 'Modular Studio',
    ...
    colorScheme: { primary: '#0F0F0F', accent: '#D1FF3D', background: '#000', text: '#FFF' }
  },
  {
    id: 'photobook',
    name: 'Photobook',
    ...
    colorScheme: { primary: '#000', accent: '#666', background: '#FFF', text: '#333' }
  },
  {
    id: 'club-flyer',
    name: 'Club Flyer',
    ...
    colorScheme: { primary: '#000', accent: '#FF00FF', background: '#000', text: '#FFF' }
  },
  {
    ...
    colorScheme: { primary: '#000', accent: '#F5F5F5', background: '#FDFDFD', text: '#1A1A1A' }
  },
  {
    id: 'zine-editorial',
    name: 'Zine Editorial',
    ...
    colorScheme: { primary: '#000', accent: '#FFD700', background: '#FFFEF0', text: '#1A1A1A' }
  },
  {
    ...
    colorScheme: { primary: '#1A1A1A', accent: '#D1FF3D', background: '#0F0F0F', text: '#FFF' }
  },
  {
    id: 'photo-lead',
    name: 'Photo-Lead',
    ...
    colorScheme: { primary: '#222', accent: '#D1FF3D', background: '#000', text: '#FFF' }
  }
];
