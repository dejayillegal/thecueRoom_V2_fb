...
export default memo(function SpotlightSection({ initialFeeds = [], initialTrending = [] }: { initialFeeds?: FeedItem[]; initialTrending?: FeedItem[] }) {
  ...
  return (
    <div className="relative">
      <section 
        className="relative h-[100vw] md:h-[85vh] group bg-[#0B0B0B] overflow-hidden cursor-pointer" 
      ...
      >
        ...
        <motion.div 
          ...
          className="absolute inset-0 flex flex-col justify-start md:justify-end pt-24 md:pt-0 pb-8 md:pb-24"
        >
          <div className="max-w-screen-2xl mx-auto px-6 md:px-10 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-1 gap-6 md:gap-12 items-start md:items-end">
