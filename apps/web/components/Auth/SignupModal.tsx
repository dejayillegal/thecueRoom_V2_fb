          ...
          <form onSubmit={handleSubmit} className="space-y-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
              <div className="space-y-5">
                <Label className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 font-bold">First Name</Label>
                <Input value={firstName} onChange={e => setFirstName(e.target.value)} className="bg-transparent border-white/20 text-white h-16 rounded-none px-8 transition-all duration-500 focus:border-[#D1FF3D] focus:ring-0 text-lg font-light tracking-tight border-2 placeholder:text-zinc-700" placeholder="Legal First Name" required />
              </div>
              <div className="space-y-5">
                <Label className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 font-bold">Last Name</Label>
                <Input value={lastName} onChange={e => setLastName(e.target.value)} className="bg-transparent border-white/20 text-white h-16 rounded-none px-8 transition-all duration-500 focus:border-[#D1FF3D] focus:ring-0 text-lg font-light tracking-tight border-2 placeholder:text-zinc-700" placeholder="Legal Last Name" required />
              </div>
            </div>

            <div className="space-y-5">
              <Label className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 font-bold">Email Address</Label>
              <div className="relative">
                <Input type="email" value={email} onChange={e => setEmail(e.target.value)} className="bg-transparent border-white/20 text-white h-16 pr-14 rounded-none px-8 transition-all duration-500 focus:border-[#D1FF3D] focus:ring-0 text-lg font-light tracking-tight border-2 placeholder:text-zinc-700" placeholder="communication@network.com" required />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
              <div className="space-y-5">
                <Label className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 font-bold">Security Pass</Label>
                <Input type="password" value={password} onChange={e => setPassword(e.target.value)} className="bg-transparent border-white/20 text-white h-16 rounded-none px-8 transition-all duration-500 focus:border-[#D1FF3D] focus:ring-0 text-lg font-light tracking-tight border-2 placeholder:text-zinc-700" placeholder="Min. 10 characters" required />
              </div>
              <div className="space-y-5">
                <Label className="text-[9px] uppercase tracking-[0.4em] text-zinc-500 font-bold">Confirm Pass</Label>
                <Input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} className="bg-transparent border-white/20 text-white h-16 rounded-none px-8 transition-all duration-500 focus:border-[#D1FF3D] focus:ring-0 text-lg font-light tracking-tight border-2 placeholder:text-zinc-700" placeholder="Verify security pass" required />
              </div>
            </div>
            ...
            <div className="py-6">
              <div className="flex items-center gap-6">
                <Switch
                  ...
                  className="data-[state=checked]:bg-[#D1FF3D] scale-125"
                />
                <Label
                  htmlFor="artist-mode"
                  className="text-[10px] font-mono uppercase tracking-[0.5em] text-[#D1FF3D] cursor-pointer font-bold"
                >
                  Register as Artist
                </Label>
              </div>
            ...
            <Button type="submit" disabled={isSubmitting} className="w-full bg-[#D1FF3D] hover:bg-white text-black font-bold h-20 rounded-none transition-all duration-700 uppercase tracking-[0.6em] text-[12px] border-none group active:scale-[0.98] shadow-[0_0_40px_rgba(209,255,61,0.15)]">
